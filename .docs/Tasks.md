...
1. Контрольные – нет поиска по задачам предмета (только по банку задач) – сделать как в Работах (поиск и в банке и в задачах предмета)
2. Если в шаге есть контент – спрашивать перед удалением шага
3. При попытке создать вопрос в уроке в модальном окне пишет «Ошибка сети.»
4. Поправить шаги в уроках:
- Текст (уже есть, оставить)
- Видео (уже есть, оставить)
- Задача – берётся либо с сайта, либо с банка задач. Тут без разницы какой тип, нужно подстраиваться под любой – это вопрос с выбором ответа, задание ЕГЭ с сайта или приватная задача с интерпретатором
- Работа (из пункта Работы)
- Контрольная (из пункта Контрольные)
5. Ссылки на уроки: стоит ли делать публичные ссылки? Все равно доступа к урокам быть не должно ни у кого, кроме как из своего курса. А на курсе лучше бы использовать простую нумерацию по типу: модуль-урок-шаг (inf_ege/ege_base/m1l2s3 – информатика егэ, курс егэ базовй, модуль 1, урок 2, шаг 3)
6. При переключении редактора шага "Текст" из "Визуально" в "Код" пропадает сама textarea 