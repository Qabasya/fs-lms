...
>
> **Остаётся post-v1 (🔶 D7, вне Эпика 11):** T7.6 модель ДЗ, T3.4 рубрики/PDF-аннотирование/пир-ревью — каждая требует своей схемы и отдельного планирования.
