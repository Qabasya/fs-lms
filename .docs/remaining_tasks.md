...
## Багфикс
1. Добавить фильтрацию только по существующим записям действий в таблице logs-8-auth (по примеру остальных таблиц, например logs-1-entity-audit)
2. Добавить фильтрацию только по существующим записям действий и имени пользователя в таблице logs-1-audit (по примеру остальных таблиц, например logs-1-entity-audit)