...
class OgeScaleConfig {
	...
	/**
	 * Сколько позиций ответа занимает задание в листе ответов — у ОГЭ, в
	 * отличие от КЕГЭ (№26/№27, {@see KegeScaleConfig::answerSlots()}), таких
	 * заданий нет: каждая позиция (включая альтернативу 13.1/13.2) даёт ровно
	 * одну строку листа ответов.
	 */
	public static function answerSlots(): int {
		return 1;
	}
	 ...
	 * таблица, не редактируется автором конкретного экзамена. Позиции 13/14/
	 ...
	 *
	 * @param string $position Номер/позиция задания («1»…«12», «13», «14», «15», «16»)
	 */
