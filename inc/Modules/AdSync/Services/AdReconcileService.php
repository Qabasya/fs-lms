...
class AdReconcileService {
	 ...
	 *
	 * По provision_subjects список НЕ фильтруется намеренно: это «кто должен ОСТАТЬСЯ активным»,
	 * лишний логин здесь — no-op (Python отключает только тех, кого в списке нет), а фильтрация
	 * могла бы отключить живые учётки при смене списка предметов.
	 *
	 * @return string[]
	 */
