				...
				<div class="fs-card__header">
					<div class="fs-card__info">
						<span class="fs-lms-auth-icon">
							<?php
							// Единый источник бренд-логотипов — core-партиал (модулю можно использовать core, не наоборот).
							$provider = 'google';
							require FS_LMS_PATH . 'templates/admin/components/modals/partials/provider-logo.php';
							?>
                        </span>
