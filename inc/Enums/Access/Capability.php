...
// ===== Администрирование =====
	...
	/**
	 * Право авторинга КОНТЕНТА банка (задачи/работы/экзамены) — subject-scoped, БЕЗ структуры курса.
	 * Выдаётся методисту/офису И преподавателю: позволяет создавать/редактировать банк-контент на
	 * фронте (плеер, «Настроить урок»), не открывая билдер курса (тот — на AuthorLmsCourses).
	 */
	case AuthorLmsBank = 'author_lms_bank';
