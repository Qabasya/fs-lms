...
| Пропущено занятие | Через час после того, как преподаватель поставил Н в журнале (с точностью до тика крона — до 1 ч 15 мин). Других условий нет. Н, исправленная или снятая за этот час, не уведомляет; исправленная позже — отзывает уже пришедшее уведомление |
...
| Пропущено занятие | Через час после Н в журнале — одновременно с ребёнком и по тем же правилам |
