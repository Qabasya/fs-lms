...
| Пропущено занятие | Началось следующее занятие, а ученик на прошлом отсутствовал, урок не открыл и ДЗ (если было) не сдал |
...
| Пропущено занятие | Те же условия, что у ученика |
