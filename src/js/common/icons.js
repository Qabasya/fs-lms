...
export const icoArrowRight = ( s = 14, c = 'currentColor' ) =>
	stroke20( '<path d="M4 10h11m0 0-4-4m4 4-4 4" stroke="{c}" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>', s, c );
...
export const STEP_GLYPHS = {
	...
	broadcast:  '<path fill-rule="evenodd" d="M22.4 12A10.4 10.4 0 1 0 1.6 12A10.4 10.4 0 1 0 22.4 12ZM20.6 12A8.6 8.6 0 1 0 3.4 12A8.6 8.6 0 1 0 20.6 12ZM18.6 12A6.6 6.6 0 1 0 5.4 12A6.6 6.6 0 1 0 18.6 12ZM16.8 12A4.8 4.8 0 1 0 7.2 12A4.8 4.8 0 1 0 16.8 12ZM14.4 12A2.4 2.4 0 1 0 9.6 12A2.4 2.4 0 1 0 14.4 12Z"/>',
