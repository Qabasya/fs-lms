...
function collectFormData() {
    ...
    return {
        ...
        student_full_name: get( 'student_full_name' ),
        school:            get( 'school' ),
        grade:             get( 'grade' ),
        ...
        parent_full_name:  get( 'parent_full_name' ),
...
function validateForm( data ) {
    const required = [
        'student_full_name', 'school', 'grade', 'student_birth_date',
        'student_doc_type', 'student_doc_number',
        'parent_full_name', 'parent_birth_date', 'relation_type',
