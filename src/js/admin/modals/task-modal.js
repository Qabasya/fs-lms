...
export const TaskModal = {
     ...
     */
    _bindEvents() {
        // ПАТТЕРН: Перехват кнопки "Добавить новую" (нативной WP page-title-action
        // на edit.php и кастомной кнопки на странице предмета).
        // Вместо того чтобы удалять кнопку из DOM, мы перехватываем клик по ней.
        // Селектор завязан на href (ведёт на post-new.php?post_type=...), а не на CSS-класс,
        // т.к. визуальные классы кнопки на разных страницах могут отличаться.
        ...
        $('body')
            .off('click.fs', 'a[href*="post-new.php"]') // Удаляем старые обработчики во избежание дублирования
            .on('click.fs', 'a[href*="post-new.php"]', (e) => {
