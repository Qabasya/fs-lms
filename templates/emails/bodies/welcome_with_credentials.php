<?php
/**
 * Разметка письма «Данные для входа» — ЕДИНСТВЕННЫЙ источник.
 *
 * Возвращает HTML с плейсхолдерами `{parent_first_name}`, `{parent_middle_name}`,
 * `{student_full_name}`, `{login}`, `{password}`, `{login_url}`: письмо подставляет
 * значения, вкладка «Шаблоны писем» показывает ту же разметку как заготовку.
 *
 * @package FS LMS
 */
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#fdfdfb; border-radius:14px; border:1px solid #dfe3ec;">
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td style="padding:4px 0;">
                        ...
                        <span style="font-family:'Courier New', Courier, monospace; font-size:18px; font-weight:bold; color:#232a3d; line-height:28px; mso-line-height-rule:exactly;">{login}</span>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="padding:4px 0;">
                        ...
                        <span style="font-family:'Courier New', Courier, monospace; font-size:18px; font-weight:bold; color:#232a3d; line-height:28px; mso-line-height-rule:exactly;">{password}</span>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;">
              <tr>
                <td bgcolor="#3556c9" style="background:#3556c9; border-radius:10px;">
                  <a href="{login_url}" style="display:block; padding:15px 44px; font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:bold; color:#ffffff; text-decoration:none;">Войти в личный кабинет</a>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="padding:4px 40px 24px 40px; text-align:center;">
            <span style="font-size:13px; color:#7a8194; line-height:19px; mso-line-height-rule:exactly;">или откройте страницу входа: <a href="{login_url}" style="color:#3556c9;">future-step.ru/sign-in</a></span>
          </td>
        </tr>
        <tr>
          <td style="padding:0 40px;">
