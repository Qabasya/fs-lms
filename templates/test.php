...
<div id="fs-subject-modal" class="fs-modal" style="display:none;">
    <div class="fs-modal-content">
        ...
        <form id="fs-add-subject-form">
            ...
            <div class="fs-form-group">
                <label for="subj_tasks_count">Количество типов заданий (от <?php echo Inc\Core\BaseController::MIN_TASKS_COUNT; ?> до <?php echo Inc\Core\BaseController::MAX_TASKS_COUNT; ?>)</label>
